...
export const metadata: Metadata = {
  title: "Sign In — Modulyn",
  description: "Sign in to your Modulyn account to manage events and participate.",
};
  ...
  return (
    ...
    >
      <div className="w-full max-w-[400px] flex flex-col items-center gap-6">
        {/* Page heading above the Clerk card */}
        <div className="text-center space-y-1">
          <h1 className="text-2xl font-bold text-[var(--text-primary)] tracking-tight">Welcome back</h1>
          <p className="text-sm text-[var(--text-muted)]">Sign in to continue to Modulyn</p>
        </div>
        <SignIn
